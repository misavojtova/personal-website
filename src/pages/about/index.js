...
const About = () => {
  return (
    <div className='cm-flex-col'>
      ...
      <h6>
        I'm a freelance Front-end React Developer originally from Czech Republic, but working remote
        in EU countries with my current location in Lisbon, Portugal. I started my developer journey
        in 2020 when I learned the basics of programming and created my first web application from
        scratch with the help of Green Fox Academy and their 3 week course. Their structure helped
        me to get familiar with HTML, CSS, JavaScript, Git and GitHub. After that I studied multiple
        courses about modern JavaScript (ES6+), HTML/CSS Flexbox, and CSS Grid on Udemy and YouTube.
      </h6>
